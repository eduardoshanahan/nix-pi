...
in
  lib.recursiveUpdate {
    ...
    fileSystems."/mnt/media" = {
      device = "192.0.2.12:/volume1/Media";
      fsType = "nfs";
      options = [
        "nofail"
        "x-systemd.automount"
    ...
    services.ghost.instances = {
      blog = {
        ...
        mail = {
          ...
          host =
            if hasSmtpRelayModule
            then "smtp-relay.${config.lab.domain}"
            else "smtp.gmail.com";
          port =
            if hasSmtpRelayModule
            then 2525
          ...
          user =
            if hasSmtpRelayModule
            then ""
            else "eduardoshanahan@gmail.com";
    ...
    services.alertmanager = {
      ...
      notifications = {
        email = {
          ...
          smarthost =
            if hasSmtpRelayModule
            then "smtp-relay.${config.lab.domain}:2525"
