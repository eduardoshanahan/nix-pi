...
- `pi-node-c`: `nix build .#nixosConfigurations.pi-node-c-sd.config.system.build.sdImage`
- `pi-node-a`: `nix build .#nixosConfigurations.pi-node-a-sd.config.system.build.sdImage`
